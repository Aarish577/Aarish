...
<%@page import="com.riveyra.Answers"%>
<%@page import="com.riveyra.Exams"%>
<%@page import="com.riveyra.Questions"%>
...
<!-- SIDEBAR -->
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a  href="std-page.jsp"><h2>Profile</h2></a>
						<a href="exam.jsp"><h2>Exams</h2></a>
						<a class="active" href="results.jsp"><h2>Results</h2></a>
					</div>
				</div>
    ...
    <tbody>
        ...
        <%
            ArrayList list=pDAO.getAllResultsFromExams(Integer.parseInt(session.getAttribute("user_id").toString()));
